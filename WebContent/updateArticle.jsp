<%@page import="DAO.ajouter_article"%>
...
<fmt:setBundle basename="Resources.message"/>
                ...
                <li>
                    <div class="row-fluid">
                      ...
                      <div class="span6">
                        <div class="img-basket-info">
                          <a href="updateArticle.jsp?idA=<%=request.getParameter("idA") %>&&idE=<%=request.getParameter("idE") %>&&value=fr">Français</a>
                          <a href="updateArticle.jsp?idA=<%=request.getParameter("idA") %>&&idE=<%=request.getParameter("idE") %>&&value=fr" class="tag">France</a>  
                  ...
                  <li>
                    <div class="row-fluid">
                      ...
                      <div class="span6">
                        <div class="img-basket-info">
                          <a href="updateArticle.jsp?idA=<%=request.getParameter("idA") %>&&idE=<%=request.getParameter("idE") %>&&value=en">Englais</a>
                          <a href="updateArticle.jsp?idA=<%=request.getParameter("idA") %>&&idE=<%=request.getParameter("idE") %>&&value=en" class="tag">USA</a>  
                        </div><!--  end img-basket-info -->
                      </div> <!-- end span6 -->
                      <div class="span1">
                        <a href="#" class="basket-remover"><i class="icon-remove"></i></a>
    ...
    if (request.getParameter("value").equals("fr")){
    	...
    	response.sendRedirect("updateArticle.jsp?idA="+request.getParameter("idA"));
            ...
            <div class="single-image-container">
              <div class="row-fluid">
                <div class="span11">
                  ...
                  <h4 class="title"><fmt:message key="message.modart"/></h4>
...
<% Article a=ajouter_article.getArt(Integer.parseInt(request.getParameter("idA"))); %>
          ...
          <div class="span6">
            ...
            <div class="form-item-description" >
             ...
             <legend><fmt:message key="message.messagerec"/></legend>
                <input type="text" class="span3" placeholder="object" name="object" value="<%=a.getObjet()%>">
            </fieldset>
            
                <fieldset>
                  <legend><fmt:message key="message.titre"/></legend>
                  <textarea name="message" id="" cols="5" rows="8" placeholder="description" ><%=a.getDescription()%></textarea>
                  <input type="hidden" name="idA" value="<%=request.getParameter("idA")%>">
                  <input type="submit" class="btn btn-primary btn-large" value="<fmt:message key="message.mod"/>"></input>
                   <input type="reset" class="btn btn-default btn-large" value="<fmt:message key="message.annuler"/>"></input>
                </fieldset>
              </form>
            </div>
