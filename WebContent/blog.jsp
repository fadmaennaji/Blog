...
<fmt:setBundle basename="Resources.message"/>
                ...
                <li>
                    <div class="row-fluid">
                      ...
                      <div class="span6">
                        <div class="img-basket-info">
                          <a href="blog.jsp?value=fr">Français</a>
                          <a href="blog.jsp?value=fr" class="tag">France</a>  
                  ...
                  <li>
                    <div class="row-fluid">
                      ...
                      <div class="span6">
                        <div class="img-basket-info">
                          <a href="blog.jsp?value=en">Englais</a>
                          <a href="blog.jsp?value=en" class="tag">USA</a>  
                        </div><!--  end img-basket-info -->
                      </div> <!-- end span6 -->
                      <div class="span1">
                        <a href="#" class="basket-remover"><i class="icon-remove"></i></a>
  ...
  <% if(request.getParameter("value")!=null){
    ...
    <% ajouter_article at=new ajouter_article();
		ArrayList<Article> liv =at.Allarticle();
	...
	<% for(int i=0;i<liv.size();i++)
		{ Etudiant e=DAOEtudiant.getEtd(liv.get(i).getId_user()); %>
		<div class="span6">
                <article class="recent-post">
                 <ul class="unstyled inline meta-info">
                   <li><img src="profile/<%=e.getImage() %>" alt="avatar" style="border-radius: 20%; width: 62px; height: 62px;" /></li>
                       <li><a href="<%if(liv.get(i).getId_user() == idE){
                		  %>profile.jsp<%}
                	   else 
                	   { %>ProfileDetail.jsp?idE=<% out.println(liv.get(i).getId_user());}%>" class="author"><% out.println(e.getNom()+" "+e.getPrenom());%></a></li>
